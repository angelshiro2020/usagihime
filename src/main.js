window.addEventListener("load", function() {
    var url = 'https://script.google.com/macros/s/AKfycbxa-QXPVnKQ1Rg-xSA8U0cjA1TIlK1_y0m9clhMaxSZNCgMuQdTbtciAv9ie3ow1C96IA/exec';
    fetch(url).then(function(response) {
        ...
        if (data.live == "upcoming") {
            document.querySelector('#subtitlebox').innerHTML = "兔姬就快開台了，還不快去待機：";
            ...
            document.querySelector('#subtitlebox').innerHTML = "兔姬正在開台，還不快去看：";
            document.querySelector('#loadingboxl').style.display = 'none';
            document.querySelector('#videoboxl').style.display = 'block';
            var ytplayere = document.createElement("iframe");
            ytplayere.setAttribute("src", data.vidi);
            ...
            document.querySelector('#subtitlebox').innerHTML = "距離兔姬上次開台，已經過了：";
            document.querySelector('#loadingboxl').style.display = 'none';
...
function gettime() {
    ...
    let stime = "兔姬已經" + sday + "天" + shour + "小時" + smin + "分鐘" + ssec + "秒沒開台了";
    return stime;
}
